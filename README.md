...
PETOM은 보호자가 반려동물의 피부 질환 사진을 업로드해서 피부 질환 증상에 대한 AI 진단을 받을 수 있습니다.   
보호자가 직접 찍은 반려동물 피부 사진을 업로드하면 관련 증상이 탐지됩니다. 탐지 결과에 따라 보호자가 전문병원 치료가 필요하다고 판단할 경우 거주 지역 주변의 동물병원을 전국 병원 지도를 통해 확인함으로써 치료로 연계할 수 있는 서비스를 제공합니다.
